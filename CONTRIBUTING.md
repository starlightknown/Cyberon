...
# 1. Introduction
**Welcome!** Thank you for contributing to the further development of Hackybotter. We're always looking for new ways to improve our project and we appreciate any help you can give us.
...
Hackybotter's repository is configured to follow a particular development workflow, using various reputable tools. We kindly ask that you stick to this workflow when contributing to Edbeepbot, by following the guides below. This will help you to easily produce quality code, identify errors early, and streamline the code review process.
...
2. Open a command line in that directory and execute the following command:
    ...
    python3 -m venv venv
    ```
    Edbeepbot, its dependencies, and all required development tools, are now installed to a virtual environment located in the `.venv` subdirectory.Hackybotter is installed in editable mode, meaning that edits you make to the source code in the repository will be reflected when you run Hackybotter.
...
* Add a upstream link to main branch in your cloned repo
    ```
    git remote add upstream https://github.com/starlightknown/hackybotter
    ```
