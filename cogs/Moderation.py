...
class ModerationCog(commands.Cog):
    ...
    async def kick_error(self, ctx, error):
        ...
        if isinstance(error, commands.MissingRequiredArgument):
            if ctx.message.author.guild_permissions.kick_members:
                ...
                await ctx.send(f'```\ncyb!kick <member_name | member_id | member_tag> <reason>\nMissing Required Argument member_name\n```')
            else:
                embed = discord.Embed(
                        title='**YOU ARE NOT AUTHORIZED**',
                        description="You do not have the authorization to perform this action\nYour action will be reported",
            ...
            await ctx.send(f'An error occured \n```\n{error}\n```\nPlease check the console for traceback, or raise an issue to cyberon')
            raise error
    ...
    async def error_multikick(self, ctx, error):
        if (
            ...
            and ctx.message.author.guild_permissions.kick_members
        ):

            await ctx.send(f'```\ncyb!multikick ...<member_name | member_id | member_tag> <reason>\nMissing Required Argument member_name\n```')
        elif (
            isinstance(error, commands.MissingRequiredArgument)
            or not isinstance(error, discord.Forbidden)
    ...
    async def error_multiban(self, ctx, error):
        if (
            isinstance(error, commands.MissingRequiredArgument)
            and ctx.message.author.guild_permissions.ban_members
        ):

            await ctx.send(f'```\ncyb!multiban ...<member_name | member_id | member_tag> <reason>\nMissing Required Argument member_name\n```')
        elif (
            isinstance(error, commands.MissingRequiredArgument)
            or not isinstance(error, discord.Forbidden)
            and isinstance(error, commands.CheckFailure)
    ...
    async def ban(self, ctx, member, *, reason=None):
        ...
        if ctx.message.author.guild_permissions.ban_members:
            ...
            if len(multiple_member_array) == 1:
                ...
                elif ctx.guild.me.top_role > multiple_member_array[0].top_role:
    ...
    async def ban_error(self, ctx, error):
        ...
        if isinstance(error, commands.MissingRequiredArgument):
            if ctx.message.author.guild_permissions.ban_members:
                ...
                await ctx.send(f'```\ncyb!ban <member_name | member_id | member_tag> <reason>\nMissing Required Argument member_name\n```')
            else:
                embed = discord.Embed(
                        title='**YOU ARE NOT AUTHORIZED**',
                        description="You do not have the authorization to perform this action\nYour action will be reported",
    ...
    async def ban_error(self, ctx, error):
        ...
        if isinstance(error, commands.MissingRequiredArgument):
            if ctx.message.author.guild_permissions.ban_members:
                ...
                await ctx.send('```\ncyb!softban <member_name | member_id | member_tag> <reason>\nMissing Required Argument member_name\n```')
            else:
                embed = discord.Embed(
                        title='**YOU ARE NOT AUTHORIZED**',
                        description="You do not have the authorization to perform this action\nYour action will be reported",
        ...
        if ctx.guild.me.guild_permissions.ban_members:
            ...
            if ctx.message.author.guild_permissions.ban_members:
                ...
                if member.isdigit():
                    ...
                    if member.find("#") not in [-1, len(member) + 1]:            
                        member_name, member_discriminator = member.split('#')
                    else:
                        await ctx.send(f"```\ncyb!unban <username>#<discriminator>\nMissing required argument discriminator\n```")
                        return
    ...
    async def unban_error(self, ctx, error):
        ...
        if isinstance(error, ValueError):
            if ctx.message.author.guild_permissions.ban_members:
                ...
                await ctx.send(f"Too few arguments\nSyntax: `cyb!unban <username>#<discriminator>`")
            else:
                embed = discord.Embed(
                        title='**YOU ARE NOT AUTHORIZED**',
                        description="You do not have the authorization to perform this action\nYour action will be reported",
                ...
                if str(multiple_member_array[0].name) == str(ctx.author.name):
                    ...
                    if muted1 is not None:
                        for role in multiple_member_array[0].roles:
                            if role is not None and role.id == muted1.id:
                                is_user_muted = True
                            else:
                                is_user_muted = False
                        if is_user_muted:
                            ...
                            await ctx.send(embed=embed)
                        elif ctx.guild.me.top_role > muted1:
    ...
    async def mute_error(self, ctx, error):
        if isinstance(error, commands.MissingRequiredArgument):
            if ctx.author.guild_permissions.manage_roles:
                ...
                await ctx.send(f'```\ncyb!mute <member_name | member_id | member_tag>\nMissing Required Argument member_name\n```')
            else:
                embed = discord.Embed(
                        title='**YOU ARE NOT AUTHORIZED**',
                        description="You do not have the authorization to perform this action\nYour action will be reported",
    ...
    async def unmute_error(self, ctx, error):        
        if isinstance(error, commands.MissingRequiredArgument):
            if ctx.author.guild_permissions.manage_roles:
                ...
                await ctx.send(f'```\ncyb!unmute <member_name | member_id | member_tag>\nMissing required Argument member_name\n```')
            else:
                embed = discord.Embed(
                        title='**YOU ARE NOT AUTHORIZED**',
                        description="You do not have the authorization to perform this action\nYour action will be reported",
                ...
                if member is None:
                    ...
                    if add_role is not None:
                        ...
                        if does_have_role:
                            ...
                            await ctx.send(embed=embed)
                        elif ctx.guild.me.top_role > add_role:
    ...
    async def addrole_error(self, ctx, error):        
        if isinstance(error, commands.MissingRequiredArgument):
            if ctx.author.guild_permissions.manage_roles:            
                ...
                await ctx.send(f'```\ncyb!addrole <member_name | member_id | member_tag> <role>\nMissing required Argument member_name\n```')
            else:
                embed = discord.Embed(
                        title='**YOU ARE NOT AUTHORIZED**',
                        description="You do not have the authorization to perform this action\nYour action will be reported",
    ...
    async def addrole_error(self, ctx, error):
        ...
        if isinstance(error, commands.MissingRequiredArgument):
            if ctx.message.author.guild_permissions.manage_roles:
                ...
                await ctx.send(f'```\ncyb!removerole <member_name | member_id | member_tag> <role>\nMissing required Argument member_name\n```')
            else:
                embed = discord.Embed(
                        title='**YOU ARE NOT AUTHORIZED**',
                        description="You do not have the authorization to perform this action\nYour action will be reported",
    ...
    async def warn_error(self, ctx, error):
        if isinstance(error, commands.MissingRequiredArgument):
            ...
            await ctx.send(f"```\ncyb!warn <member_name | member_id | member_tag>\nMissing required argument member name\n```")
        else:
            await ctx.send(f'An error occured \n```\n{error}\n```\nPlease check the console for traceback, or raise an issue to cyberon')
            raise error
    ...
    async def warns_error(self, ctx, error):
        if isinstance(error, commands.MissingRequiredArgument):
            ...
            await ctx.send(f'```\ncyb!warns <member_name | member_id | member_tag>\nMissing required argument member name\n```')
        else:
            await ctx.send(f'An error occured \n```\n{error}\n```\nPlease check the console for traceback, or raise an issue to cyberon')
            raise error
    ...
    async def clear_warns_error(self, ctx, error):
        if isinstance(error,  commands.MissingRequiredArgument):
            ...
            await ctx.send(f'```\ncyb!clearwarns <member_name | member_id | member_tag>\nMssing required argument member name\n```')
        else:    
            await ctx.send(f'An error occured \n```\n{error}\n```\nPlease check the console for traceback, or raise an issue to cyberon')
            raise error
